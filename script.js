...
const STAT_NAMES_SHORT = [ //names used to draw the stats
    "HP",
    "ATK",
    "DEF",
    "SPA",
...
function randomMoveAbility() {
    ...
    document.getElementById('move0').textContent = MOVES_LIST[newMoveID];
    document.getElementById('ability0').textContent = ABILITY_LIST[newAbilityID];
}
